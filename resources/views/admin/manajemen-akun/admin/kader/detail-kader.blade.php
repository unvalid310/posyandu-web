        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Kader') }}">Data Kader</a>
                    </li>
                        ...
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    src="{{ route('Get Profile Image Admin', $pegawai->admin->id) }}" alt="Profile Admin"
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#ubahProfile" data-toggle="tab">Ubah Profile</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="profile">
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KTP Kader', $pegawai->id) }}" class="card-img-buttom"
                                        alt="...">
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Kader', $pegawai->id) }}" method="POST"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama', $pegawai->nama_pegawai) }}" placeholder="Nama Kader"
                                            required>
                                        ...
                                        @else
                                            <div class="invalid-feedback">
                                                Nama lengkap kader wajib diisi
                                            </div>
                                        @enderror
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $pegawai->nik) }}" placeholder="NIK Kader" required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    placeholder="Tempat Lahir Kader" required>
                                                ...
                                                @else
                                                    <div class="invalid-feedback">
                                                        Tempat lahir kader wajib diisi
                                                    </div>
                                                @enderror
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        ...
                                                        id="floatingInput" placeholder="Tanggal Lahir Kader"
                                                    ...
                                                    @else
                                                        <div class="invalid-feedback">
                                                            Tanggal lahir kader wajib diisi
                                                        </div>
                                                    @enderror
                                                </div>
                                            </div>
