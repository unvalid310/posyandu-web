...
@push('css')
    ...
    <link rel="stylesheet" href="{{ url('base-template/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <link rel="stylesheet"
        href="{{ url('base-template/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}">
            ...
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none"
                            href="{{ route('Admin Home') }}">Posyandu</a></li>
                                ...
                                <div class="bs-stepper-content p-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="inputNamaPosyandu">Nama Posyandu<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="nama_posyandu"
                                                            class="form-control @error('nama_posyandu') is-invalid @enderror"
                                                            id="inputNamaPosyandu" value="{{ old('nama_posyandu') }}"
                                                            placeholder="Nama Posyandu" autocomplete="off">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Nomor Telp Posyandu<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('telp_posyandu') is-invalid @enderror"
                                                            name="telp_posyandu" value="{{ old('telp_posyandu') }}"
                                                            placeholder="Masukan nomor telepon aktif" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="kabupaten" name="kabupaten"
                                                        class="form-control select2 kabupaten @error('kabupaten') is-invalid @enderror"
                                                        style="width: 100%;">
                                                        <option selected disabled>Pilih Kabupaten/Kota</option>
                                                        @foreach ($kabupaten as $k)
                                                            <option value="{{ $k->id }}">
                                                                {{ ucfirst($k->nama_kabupaten) }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('kabupaten')
                                                        <div class="invalid-feedback text-start">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="inputKecamatan">Kecamatan<span
                                                            class="text-danger">*</span></label>
                                                    <select id="kecamatan" name="kecamatan"
                                                        class="form-control select2 kecamatan @error('kecamatan') is-invalid @enderror"
                                                        style="width: 100%;">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="inputLat">Koordinat Latitude<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('lat') is-invalid @enderror"
                                                            name="lat" id="inputLat" value="{{ old('lat') }}"
                                                            placeholder="Koordinat Latitude posyandu" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="inputLng">Koordinat Longitude<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('lng') is-invalid @enderror"
                                                            name="lng" id="inputLng" value="{{ old('lng') }}"
                                                            placeholder="Koordinat Longitude posyandu" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-map-marker-alt"></span>
                                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="inputAlamat">Alamat Posyandu<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('alamat_posyandu') is-invalid @enderror"
                                                            name="alamat_posyandu" id="inputAlamat"
                                                            value="{{ old('alamat_posyandu') }}"
                                                            placeholder="Masukan alamat lengkap posyandu"
                                                            autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="konfirmasiPass">Password Konfirmasi<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="password"
                                                            class="form-control @error('passwordAdmin') is-invalid @enderror"
                                                            name="passwordAdmin" id="konfirmasiPass"
                                    ...
                                    <div id="data-kedua" class="content" role="tabpanel"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            ...
                                                            placeholder="Nama lengkap admin" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Jenis Kelamin<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <select class="form-select @error('gender') is-invalid @enderror"
                                                            name="gender" id="inputGroupSelect02">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">NIK<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('nik') is-invalid @enderror"
                                                            name="nik" value="{{ old('nik') }}"
                                                            placeholder="Masukan nomor NIK" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Scan KTP<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            ...
                                                            @enderror
                                                            <label class="custom-file-label" for="exampleInputFile">Upload
                                                                scan KTP</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Tempat Lahir<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text"
                                                            ...
                                                            placeholder="Tanggal lahir" data-inputmask-alias="datetime"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('telp_pegawai') is-invalid @enderror"
                                                            name="telp_pegawai" value="{{ old('telp_pegawai') }}"
                                                            placeholder="Masukan nomor telepon aktif" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-phone-alt"></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            ...
                                                            placeholder="Masukan Username Telegram aktif"
                                                            autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Alamat E-Mail<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="email"
                                                            class="form-control @error('email') is-invalid @enderror"
                                                            name="email" value="{{ old('email') }}"
                                                            placeholder="Alamat email aktif" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Alamat<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text"
                                                            class="form-control @error('alamat_pegawai') is-invalid @enderror"
                                                            name="alamat_pegawai" value="{{ old('alamat_pegawai') }}"
                                                            placeholder="Alamat tempat tinggal" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-road"></span>
                                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Konfirmasi Password<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="password"
                                                            class="form-control @error('password_confirmation') is-invalid @enderror"
                                                            name="password_confirmation"
                                                            placeholder="Masukan kembali Password" autocomplete="off">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-lock"></span>
                                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 justify-content-end text-end">
                                                        <a href="{{ route('Data Posyandu') }}"
                                                            class="btn btn-danger my-1">Batalkan</a>
                                                        <button type="submit" class="btn btn-success my-1">Tambah
                                                            Posyandu</button>
                                                    </div>
                                                </div>
                                            </div>
            ...
            $('#kabupaten').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#kecamatan').empty();
                        $('#kecamatan').append(
                            `<option value="0" disabled selected>Pilih Kecamatan/Kota</option>`
                            );
