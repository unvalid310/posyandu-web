...
@section('title', 'Tambah Keluarga Ibu')
        ...
        <div class="col-auto ml-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="/">Posyandu</a></li>
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-anak-tab" data-bs-toggle="tab" data-bs-target="#nav-anak"
                            type="button" role="tab" aria-controls="nav-anak" aria-selected="false">Anak</button>
                        <button class="nav-link" id="nav-lansia-tab" data-bs-toggle="tab" data-bs-target="#nav-lansia"
                            type="button" role="tab" aria-controls="nav-lansia" aria-selected="false">Lansia</button>
                    </div>
                </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="email" name="email_ibu" autocomplete="off"
                                                        class="form-control @error('email_ibu') is-invalid @enderror"
                                                        value="{{ old('email_ibu') }}" placeholder="Masukan E-Mail ibu">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" name="passwordIbu" autocomplete="off"
                                                        class="form-control @error('passwordIbu') is-invalid @enderror"
                                                        value="{{ old('passwordIbu') }}" placeholder="Masukan kata sandi">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="password" name="passwordIbu_confirmation"
                                                        autocomplete="off"
                                                        class="form-control @error('passwordIbu_confirmation') is-invalid @enderror"
                                                        value="{{ old('passwordIbu_confirmation') }}"
                                        ...
                                        <div class="form-group text-end">
                                            <button type="submit" class="btn btn-sm btn-outline-primary">Daftarkan
                                                Akun</button>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="email" name="email_anak" autocomplete="off"
                                                        ...
                                                        value="{{ old('email_anak') }}"
                                                        placeholder="Masukan E-Mail anak">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="fas fa-envelope"></span>
                                                        </div>
                                        ...
                                        <div class="col-md">
                                            ...
                                            <div class="form-group">
                                                <label>Konfirmasi Kata Sandi<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <input type="password" name="passwordAnak_confirmation"
                                                        autocomplete="off"
                                                        class="form-control @error('passwordAnak_confirmation') is-invalid @enderror"
                                                        value="{{ old('passwordAnak_confirmation') }}"
                                                        placeholder="Masukan kembali kata sandi">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="fas fa-lock"></span>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" name="nama_lansia" autocomplete="off"
                                                        ...
                                                        value="{{ old('nama_lansia') }}"
                                                        placeholder="Masukan nama lengkap lansia">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="fas fa-user"></span>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="email" name="email_lansia" autocomplete="off"
                                                        ...
                                                        value="{{ old('email_lansia') }}"
                                                        placeholder="Masukan E-Mail lansia">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="fas fa-envelope"></span>
                                                        </div>
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                <label>Kata Sandi<span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <input type="password" name="passwordLansia" autocomplete="off"
                                                        class="form-control @error('passwordLansia') is-invalid @enderror"
                                                        value="{{ old('passwordLansia') }}"
                                                        placeholder="Masukan kata sandi">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="fas fa-key"></span>
                                            ...
                                            <div class="form-group">
                                                <label>Konfirmasi Kata Sandi<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <input type="password" name="passwordLansia_confirmation"
                                                        autocomplete="off"
                                                        class="form-control @error('passwordLansia_confirmation') is-invalid @enderror"
                                                        value="{{ old('passwordLansia_confirmation') }}"
                                                        placeholder="Masukan kembali kata sandi">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="fas fa-lock"></span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kabupatenIbu').on('change', function() {
                ...
                $('#kecamatanIbu').empty();
                $('#kecamatanIbu').append(
                `<option value="0" disabled selected>Silakan tunggu....</option>`);
                $.ajax({
                    type: 'GET',
                    url: '/kecamatan/' + id,
            ...
            $('#kecamatanIbu').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#desaIbu').empty();
                        $('#desaIbu').append(
                            `<option value="0" disabled selected>Pilih Desa/Kelurahan....</option>`
                            );
                        response.forEach(element => {
                            $('#desaIbu').append(
                                `<option value="${element['id']}">${element['nama_desa']}</option>`
                                );
                        });
                    }
                });
            ...
            $('#desaIbu').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#banjarIbu').empty();
                        $('#banjarIbu').append(
                            `<option value="0" disabled selected>Pilih Banjar....</option>`);
                        response.forEach(element => {
                            $('#banjarIbu').append(
                                `<option value="${element['id']}">${element['banjar']}</option>`
                                );
                        });
                    }
                });
