...
<head>
    ...
    <link rel="stylesheet"
        href="{{ url('base-template/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        {{-- Navbar Start --}}
        @include('layouts/user/anak/navbar-layout')
        {{-- Navbar End --}}

        {{-- Sidebar Container Start --}}
        @include('layouts/user/anak/sidebar-layout')
        {{-- Sidebar Container End --}}

        {{-- Content Start --}}
        @include('layouts/user/anak/content-layout')
        {{-- Content End --}}

        {{-- Footer Start --}}
        @include('layouts/user/anak/footer-layout')
        {{-- Footer End --}}
    </div>
    ...
    <script src="{{ url('base-template/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
