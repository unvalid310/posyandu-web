            ...
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none"
                            href="{{ route('Tambah Konsultasi') }}">Konsultasi</a></li>
                        ...
                        <div class="card card-primary card-outline">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-10 my-auto">
                                            <p class="my-auto fw-bold fs-5 text-start">Data Persalinan Sebelumnya</p>
                                        </div>
                                        <div class="col-2 d-flex align-items-center justify-content-end"><a
                                                class="btn btn-primary" data-bs-toggle="collapse" href="#tambahKelahiran"
                                                role="button" aria-expanded="false" aria-controls="tambahKelahiran"><i
                                        ...
                                        <form action="{{ route('Tambah Data Persalinan', $dataIbu->id) }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-12 my-2">
                                                    <label for="nama_anak" class="form-label">Nama Anak<span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control @error('berat_lahir') is-invalid @enderror"
                                                        list="dataAnak" id="nama_anak" name="nama_anak"
                                                ...
                                                <div class="col-sm-12 col-md-6 my-2">
                                                    <label for="tanggal_persalinan">Tanggal Persalinan<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" name="tanggal_persalinan" autocomplete="off"
                                                            class="form-control @error('tanggal_persalinan') is-invalid @enderror"
                                                            id="tanggal_persalinan" value="{{ old('tanggal_persalinan') }}"
                                                            placeholder="Tanggal persalinan" data-inputmask-alias="datetime"
                                                ...
                                                <div class="col-sm-12 col-md-6 my-2">
                                                    <label for="berat_lahir">Berat Lahir Bayi<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" name="berat_lahir" autocomplete="off"
                                                            class="form-control @error('berat_lahir') is-invalid @enderror"
                                                            id="berat_lahir" value="{{ old('berat_lahir') }}"
                                                            placeholder="LK Anak">
                                                ...
                                                <div class="col-sm-12 col-md-6 my-2">
                                                    <label for="persalinan">Persalinan<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <select name="persalinan"
                                                            class="form-control @error('persalinan') is-invalid @enderror"
                                                            id="persalinan">
                                                ...
                                                <div class="col-sm-12 col-md-6 my-2">
                                                    <label for="penolong_persalinan">Penolong Persalinan<span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <select name="penolong_persalinan"
                                                            class="form-control @error('penolong_persalinan') is-invalid @enderror"
                                                ...
                                                <div class="col-12 my-2">
                                                    <div class="form-floating mb-3">
                                                        <textarea type="text" name="komplikasi" class="form-control @error('komplikasi') is-invalid @enderror"
                                                            id="komplikasi" placeholder="Komplikasi kelahiran">{{ old('komplikasi') }}</textarea>
                                                        @error('komplikasi')
                                                            <div class="invalid-feedback text-start">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-12 my-2">
                                                    ...
                                                    <button type="submit" class="btn btn-block btn-success">Simpan Data
                                                        Kelahiran</button>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-10 my-auto">
                                            <p class="my-auto fw-bold fs-5 text-start">Tambah Konsultasi Ibu</p>
                                        </div>
                                        <div class="col-2 d-flex align-items-center justify-content-end"><a
                                                class="btn btn-primary" data-bs-toggle="collapse" href="#konsulIbu"
                                                role="button" aria-expanded="false" aria-controls="konsulIbu"><i
                                                    class="fas fa-plus-circle"></i></a></div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 my-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="usia_kehamilan"
                                                            class="form-control @error('usia_kehamilan') is-invalid @enderror"
                                                            id="usia_kehamilan" value="{{ old('usia_kehamilan') }}"
                                                            placeholder="Usia Kehamilan dalam minggu">
                                                        <label for="usia_kehamilan">Usia Kehamilan<span
                                                                class="text-danger">*</span></label>
                                                ...
                                                <div class="col-12 my-2">
                                                    <div class="form-floating">
                                                        <textarea name="diagnosa" class="form-control @error('diagnosa') is-invalid @enderror" id="diagnosa"
                                                            placeholder="Masukan hasil konsultasi"></textarea>
                                                        <label for="diagnosa">Hasil Konsultasi<span
                                                                class="text-danger">*</span></label>
                                                        @error('diagnosa')
                                                            <div class="invalid-feedback text-start">
                                                                {{ $message }}
                                                ...
                                                <div class="col-12 my-2">
                                                    <div class="form-floating">
                                                        <textarea name="pengobatan" class="form-control @error('pengobatan') is-invalid @enderror" id="pengobatan"
                                                            placeholder="Masukan obat atau resep"></textarea>
                                                ...
                                                <div class="col-12 my-2">
                                                    <div class="form-floating">
                                                        <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                                            placeholder="Masukan keterangan konsultasi"></textarea>
                                                ...
                                                <div class="col-12 my-2">
                                                    <p class="text-danger text-end">* Data Wajib Diisi</p>
                                                    <button type="submit" class="btn btn-block btn-success">Simpan
                                                        Catatan Konsultasi</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-10 my-auto">
                                            <p class="my-auto fw-bold fs-5 text-start">Tambah Penyakit Bawaan Ibu</p>
                                        </div>
                                        <div class="col-2 d-flex align-items-center justify-content-end"><a
                                                class="btn btn-primary" data-bs-toggle="collapse"
                                                href="#tambahPenyakitBawaan" role="button" aria-expanded="false"
                                                aria-controls="tambahPenyakitBawaan"><i
                                                    class="fas fa-plus-circle"></i></a></div>
                                    </div>
                                    <div class="collapse my-3" id="tambahPenyakitBawaan">
                                        <form action="{{ route('Tambah Penyakit Bawaan', $dataIbu->id_user) }}"
                                            method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 my-2">
                                                    <div class="form-floating mb-3">
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('nama_penyakit') }}" id="nama_penyakit"
                                                            name="nama_penyakit" placeholder="Masukan penyakit bawaan">
                                                        <label for="nama_penyakit">Nama Penyakit<span
                                                                class="text-danger">*</span></label>
                                                        @error('nama_penyakit')
                                                            <div class="invalid-feedback text-start">
                                                                {{ $message }}
                                ...
                                @if ($pemeriksaan->count() > 0)
                                    @foreach ($pemeriksaan as $data)
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-10 my-auto">
                                                    <p class="my-auto fs-6 text-start">{{ $data->jenis_pemeriksaan }}
                                                        {{ date('d M Y', strtotime($data->created_at)) }} | Oleh
                                                        {{ $data->pegawai->nama_pegawai }}</p>
                                                </div>
                                                <div class="col-2 d-flex align-items-center justify-content-end"><a
                                                        class="btn btn-primary" data-bs-toggle="collapse"
                                                        href="#pemeriksaan{{ $loop->iteration }}" role="button"
                                                        aria-expanded="false"
                                                        aria-controls="pemeriksaan{{ $loop->iteration }}"><i
                                                            class="fas fa-plus-circle"></i></a></div>
                                            </div>
                                                ...
                                                <div class="collapse my-3" id="pemeriksaan{{ $loop->iteration }}">
                                                    <div class="card card-body">
                                                        ...
                                                        @if ($data->tanggal_kembali != null)
                                                            <span class="fw-bold text-end mt-2 small">Tanggal Kembali:
                                                                <span
                                                                    class="fw-normal">{{ date('d M Y', strtotime($data->tanggal_kembali)) }}</span></span>
                                                        @else
                                                            <span class="fw-bold text-end mt-2 small">Tanggal Kembali:
                                                                <span class="fw-normal">-</span></span>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endif
                                ...
                                @if ($imunisasi->count() > 0)
                                    @foreach ($imunisasi as $data)
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-10 my-auto">
                                                    <p class="my-auto fs-6 text-start">Imunisasi
                                                        {{ date('d M Y', strtotime($data->created_at)) }} | Oleh
                                                        {{ $data->pegawai->nama_pegawai }}</p>
                                                </div>
                                                <div class="col-2 d-flex align-items-center justify-content-end"><a
                                                        class="btn btn-primary" data-bs-toggle="collapse"
                                                        href="#imunisasi{{ $loop->iteration }}" role="button"
                                                        aria-expanded="false"
                                                        aria-controls="imunisasi{{ $loop->iteration }}"><i
                                                            class="fas fa-plus-circle"></i></a></div>
                                            </div>
                                ...
                                @if ($vitamin->count() > 0)
                                    @foreach ($vitamin as $data)
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-10 my-auto">
                                                    <p class="my-auto fs-6 text-start">Vitamin
                                                        {{ date('d M Y', strtotime($data->created_at)) }} | Oleh
                                                        {{ $data->pegawai->nama_pegawai }}</p>
                                                </div>
                                                <div class="col-2 d-flex align-items-center justify-content-end"><a
                                                        class="btn btn-primary" data-bs-toggle="collapse"
                                                        href="#vitamin{{ $loop->iteration }}" role="button"
                                                        aria-expanded="false"
                                                        aria-controls="vitamin{{ $loop->iteration }}"><i
                                                            class="fas fa-plus-circle"></i></a></div>
                                            </div>
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-4 order-1 order-md-2 mb-3">
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <div class="image mx-auto d-block rounded">
                                        <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                            src="{{ route('Get Image Anggota Konsultasi', $dataIbu->user->id) }}"
                                ...
                                <ul class="list-group list-group-unbordered">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-end my-auto"><span>{{ $usia_kandungan }} Minggu</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            @else
                                                <div class="col-5 text-end my-auto"><span>Kehamilan
                                                        ke-{{ $persalinan->count() + 1 }}</span></div>
                                            @endif
                                        </div>
                                    </li>
                                    @if ($dataIbu->kehamilan_ke != null)
                                    ...
                                    @if ($alergi->where('kategori', 'Alergi Makanan')->count() > 0)
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-7 my-auto"><span class="fw-bold">Alergi Makanan</span>
                                                </div>
                                                <div class="col-5 text-end my-auto">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            @if ($dataIbu->user->golongan_darah != null)
                                                <div class="col-5 text-end my-auto">
                                                    <span>{{ $dataIbu->user->golongan_darah }}</span></div>
                                            @else
                                                <div class="col-5 text-end my-auto"><span>-</span></div>
                                            @endif
                                        </div>
                                    ...
                                    @if ($penyakitBawaan->count() > 0)
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-7 my-auto"><span class="fw-bold">Penyakit Bawaan</span>
                                                </div>
                                                <div class="col-5 text-end my-auto">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            @if ($dataIbu->user->tanggungan != null)
                                                <div class="col-5 text-end my-auto">
                                                    <span>{{ $dataIbu->user->tanggungan }}</span></div>
                                            @else
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            @if ($dataIbu->user->faskes_rujukan != null)
                                                <div class="col-5 text-end my-auto">
                                                    <span>{{ $dataIbu->user->faskes_rujukan }}</span></div>
                                            @else
                                                <div class="col-5 text-end my-auto"><span>Belum ditambahkan</span></div>
                                            @endif
                                        </div>
                                ...
                                <a href="{{ route('Detail Anggota Bumil', $dataIbu->id) }}"
                                    class="btn btn-sm btn-outline-info btn-block mt-3" target="_blank">Detail Bumil</a>
                                <a href="" class="btn btn-sm btn-outline-info btn-block mt-3">Detail Kesehatan
                                    Bumil</a>
                            </div>
                        </div>
                    </div>
