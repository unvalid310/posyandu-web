                ...
                <div class="row">
                    <div class="col-12 col-lg-3">
                        <div class="card">
                            ...
                            <div class="nav flex-column nav-pills card-body p-0" id="v-pills-tab" role="tablist"
                                aria-orientation="vertical">
                                <ul class="nav nav-pills flex-column">
                                    <li class="nav-item d-grid">
                                        <button class="nav-link btn btn-info active text-left" id="v-pills-home-tab"
                                    ...
                                    <li class="nav-item d-grid">
                                        <button class="nav-link text-left btn btn-info" id="v-pills-profile-tab"
                                    ...
                                    <li class="nav-item d-grid">
                                        <button class="nav-link text-left btn btn-info" id="v-pills-messages-tab"
                                                    ...
                                                    @foreach ($ibu as $data)
                                                        <tr class="text-center align-middle my-auto">
                                                            ...
                                                            <td class="text-center align-middle d-md-none">
                                                                <a href="{{ route('Detail Verifikasi Bumil', $data->user->id) }}"
                                                    ...
                                                    @foreach ($anak as $data)
                                                        <tr class="text-center align-middle my-auto">
                                                            ...
                                                            <td class="align-middle">
                                                                {{ date('d M Y', strtotime($data->created_at)) }}</td>
                                                            <td class="text-center align-middle d-md-none">
                                                                <a href="{{ route('Detail Verifikasi Anak', $data->user->id) }}"
                                                                    class="btn btn-success btn-sm">
                                                                    <i class="fas fa-check-square"></i>
                                                                </a>
                                                            </td>
                                                    ...
                                                    @foreach ($lansia as $data)
                                                        <tr class="text-center align-middle my-auto">
                                                            ...
                                                            <td class="align-middle">
                                                                {{ date('d-M-Y', strtotime($data->created_at)) }}</td>
                                                            <td class="text-center align-middle d-md-none">
                                                                <a href="{{ route('Detail Verifikasi Lansia', $data->user->id) }}"
                                                                    class="btn btn-success btn-sm">
                                                                    <i class="fas fa-check-square"></i>
                                                                </a>
                                                            </td>
