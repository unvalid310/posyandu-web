    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header bg-white text-center">
                ...
                <p class="login-box-msg mb-0 pb-0 px-0 pb-3 fw-bold h6">Anggota Posyandu</p>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('submit.user.login') }}" method="POST" id="form">
                    ...
                    <div class="row g-4">
                        <div class="col-5 mb-1">
                            ...
                            <a href="javascript:void(0)" class="text-decoration-none link-primary"
                                onclick="refreshCaptcha()">Ganti Captcha</a>
                        </div>
                        <div class="col-7">
                    ...
                    <div class="row mb-4">
                        <div class="col-8">
                            <div class="icheck-primary">
                                ...
                                <label for="show-hide">Tampilkan Sandi</label>
                            </div>
                        </div>
                        <div class="col-4">
                ...
                <p class="mb-1">
                    Lupa password? Klik
                    <a href="{{ route('user.form.reset-password') }}" class="text-decoration-none link-primary">di
                        sini</a>
                </p>
                <p class="mb-0">
                    Belum teregistrasi?
                    <a href="{{ route('landing.regis') }}" class="text-decoration-none link-primary">Ajukan akun
                        sekarang</a>
                </p>
            </div>
            <div class="text-center mt-4 mb-0">
                <a href="/" class="nav-link link-dark">Posyandu &copy
                    {{ date('Y', strtotime(date('Y-m-d H:i:s'))) }}</a>
            </div>
        </div>
    </div>
