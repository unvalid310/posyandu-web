    ...
    @push('css')
        ...
        <link rel="stylesheet"
            href="{{ url('base-template/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
                                ...
                                @permission('Tambah Tag Berita')
                                    ...
                                    <div class="col-6 text-end">
                                        <button class="btn btn-success" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#tambahTag" aria-expanded="false" aria-controls="tambahTag">
                            ...
                            @permission('Tambah Tag Berita')
                                <div class="collapse my-4" id="tambahTag">
                                    <div class="card card-body">
                                        <form action="{{ route('Simpan Tag') }}" method="POST" class="needs-validation"
                                            novalidate>
                                            @csrf
                                            <div class="input-group">
                                                <input type="text"
                                                    class="form-control @error('nama_tag') is-invalid @enderror"
                                                    placeholder="Masukan nama tag" name="nama_tag" autocomplete="off" required>
                                                <button class="btn btn-outline-primary" type="submit" id="button-addon2">Simpan
                                                    Tag</button>
                                                @error('nama_tag')
                                        ...
                                        <tr class="text-center align-middle my-auto">
                                            ...
                                            @permission('Hapus Tag Berita')
                                                <td class="text-center align-middle d-md-none">
                                                    <button onclick="hapusTag('{{ $data->id }}')"
