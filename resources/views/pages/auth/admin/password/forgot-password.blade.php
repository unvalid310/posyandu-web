...
<head>
    ...
    <title>Posyandu | Lupa Sandi</title>
    ...
    <div class="hold-transition login-page">
        <div class="card card-outline card-primary">
            <div class="card-header bg-white text-center">
                ...
                <a href="" class="text-decoration-none h3 fw-bold">Posyandu</a>
                <p class="login-box-msg mb-0 pb-0 px-0 pb-3 fw-bold">Pengubahan Kata Sandi</p>
            </div>
            <div class="card-body">
                <p class="text-center fs-6 pt-2 pb-1">Silakan masukan Username Telegram atau Email untuk merubah kata
                    sandi</p>
                @if (session('message'))
                        ...
                        <div class="col-md">
                            <div class="form-group mb-2">
                                ...
                                <div class="input-group">
                                    <input name="username_tele" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-outline-primary btn-sm btn-block mb-3">Kirim Kode
                                    OTP</button>
                            </div>
                        </div>
                    </form>
                    <form action="{{ route('post.email') }}" method="POST" class="col-md-6">
                        ...
                        <div class="col-md">
                            ...
                            <div class="col-12 d-flex justify-content-end p-0">
                                <button type="submit" class="btn btn-outline-primary btn-sm btn-block">Kirim Kode
                                    OTP</button>
                            </div>
                        </div>
                    </form>
