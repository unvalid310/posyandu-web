        ...
        <div class="col-auto ml-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('ibu.home') }}">Posyandu</a>
                    </li>
                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                ...
                                <a
                                    class="float-right text-decoration-none link-dark">{{ Auth::user()->ibu->posyandu->nama_posyandu }}</a>
                            </li>
                            <li class="list-group-item">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="email" class="form-control" id="inputNama" placeholder="Nama"
                                            disabled readonly value="{{ Auth::user()->ibu->nama_ibu_hamil }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputNIK" placeholder="NIK" disabled
                                            readonly value="{{ Auth::user()->ibu->nama_suami }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputNIK" placeholder="NIK" disabled
                                            readonly value="{{ Auth::user()->ibu->NIK }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputTempatLahir"
                                            ...
                                            value="{{ Auth::user()->ibu->tempat_lahir }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputTglLahir"
                                            ...
                                            value="{{ date('d-M-Y', strtotime(Auth::user()->ibu->tanggal_lahir)) }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 my-auto">
                                            <input name="no_tlpn" type="text"
                                                ...
                                                value="{{ old('no_tlpn', Auth::user()->ibu->nomor_telepon) }}">
                                            @error('no_tlpn')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
