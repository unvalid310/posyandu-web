                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <select name="pegawai"
                                                class="form-control select2 kabupaten @error('pegawai') is-invalid @enderror"
                                                id="pegawai">
                                                <option value="#" disabled selected>Pilih pegawai ...</option>
                                                @foreach ($pegawai as $pgw)
                                                    @if ($pgw->admin->id != auth()->guard('admin')->user()->id)
                                                        <option value="{{ $pgw->id }}">{{ $pgw->nama_pegawai }},
                                                            {{ $pgw->admin->email }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <select name="jabatan"
                                                class="form-control select2 kabupaten @error('jabatan') is-invalid @enderror"
                                                id="jabatan">
