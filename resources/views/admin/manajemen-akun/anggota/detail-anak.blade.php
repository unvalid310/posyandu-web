                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    ...
                                    alt="Profile Anggota Anak" width="150" height="150">
                            </div>
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            @else
                                <li class="list-group-item">
                                    <b class="fw-bold">Status Keluarga</b>
                                    <a class="float-right text-decoration-none link-dark">Anak
                                        ke-{{ $anggota->anak->anak_ke }}</a>
                                </li>
                            @endif
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="profile">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $anggota->anak->nama_anak }}" disabled readonly>
                                    <label for="floatingInput">Nama Lengkap</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $anggota->anak->NIK ?? 'Belum Ditambahkan' }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $anggota->anak->tempat_lahir ?? 'Belum Ditambahkan' }}" disabled
                                                readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ date('d M Y', strtotime($anggota->anak->tanggal_lahir)) ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $anggota->anak->nomor_telepon ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KK Anggota', $anggota->id_kk) }}" class="card-img-buttom"
                                        alt="Scan KK Anggota Anak">
                                </div>
                            </div>
                            <div class="tab-pane" id="info">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->anak->pendidikan_ibu ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->anak->pendidikan_ayah ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->anak->pekerjaan_ibu ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->anak->pekerjaan_ayah ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control"
                                        value="{{ $anggota->anak->alamat ?? 'Belum Ditambahkan' }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->no_jkn ?? '' }}" disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ date('d-M-Y', strtotime($anggota->masa_berlaku)) ?? '' }}"
                                                disabled readonly>
                            ...
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Anggota Anak', $anggota->anak->id) }}" method="POST"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama', $anggota->anak->nama_anak) }}"
                                            placeholder="Nama lengkap anak" autocomplete="off" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            class="form-control @error('nik') is-invalid @enderror" id="floatingInput"
                                            value="{{ old('nik', $anggota->anak->NIK) }}" placeholder="NIK Anak"
                                            autocomplete="off" required>
                                        <label for="floatingInput">Nomor Induk Kependudukan<span
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    id="floatingInput"
                                                    value="{{ old('tempat_lahir', $anggota->anak->tempat_lahir) }}"
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        ...
                                                        value="{{ old('tgl_lahir', date('d-m-Y', strtotime($anggota->anak->tanggal_lahir))) }}"
                                                        id="floatingInput" placeholder="Tanggal Lahir Anak"
                                                        data-inputmask-alias="datetime"
                                                        data-inputmask-inputformat="dd-mm-yyyy" data-mask required>
                                                    <label for="floatingInput">Tanggal Lahir<span
                                                            class="text-danger">*</span></label>
                                                    @error('tgl_lahir')
                                                        <div class="invalid-feedback text-start">
                                                            {{ $message }}
                                    ...
                                    <div class="form-floating mb-3">
                                        <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                            placeholder="Alamat tempat tinggal" style="height: 100px" required>{{ old('alamat', $anggota->anak->alamat) }}</textarea>
