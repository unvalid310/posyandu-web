        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Kader') }}">Semua
                            Kader</a></li>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="bs-stepper py-3">
                            ...
                            <form action="{{ route('Simpan Kader') }}" enctype="multipart/form-data" method="post"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        @else
                                                            <div class="invalid-feedback">
                                                                Jenis kelamin kader wajib dipilih
                                                            </div>
                                                        @enderror
                                                    </div>
                                                </div>
