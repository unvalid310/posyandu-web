...
<head>
    ...
    @if ($role == 'ibu')
        <title>Posyandu | Registrasi Ibu Hamil</title>
    @endif
    @if ($role == 'anak')
        <title>Posyandu | Registrasi Lansia</title>
    @endif
    @if ($role == 'lansia')
        <title>Posyandu | Registrasi Anak</title>
    @endif
    ...
    <link rel="stylesheet"
        href="{{ url('base-template/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
    ...
    <div class="container justify-content-center pt-4">
        <div class="card card-outline card-primary">
            <div class="card-header bg-white text-center">
                <img class="rounded mx-auto d-block" src="{{ asset('/images/sipandu-logo.png') }}" alt="sipandu logo"
                    width="100" height="100">
                <a href="" class="text-decoration-none h4 fw-bold">Posyandu</a>
                ...
                <form action="user/{{ $role }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('file') is-invalid @enderror"
                                        name="file" id="exampleInputFile2">
                                    <label class="custom-file-label " for="exampleInputFile2">Upload Kartu
                                        Keluarga</label>
                                </div>
                                @error('file')
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" name="email" autocomplete="off"
                                        ...
                                        value="{{ old('email') }}" placeholder="Masukan E-Mail">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span class="fas fa-user"></span>
                                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select id="kabupaten" name="kabupaten"
                                    ...
                                    @foreach ($kabupaten as $k)
                                        <option value="{{ $k->id }}">{{ ucfirst($k->nama_kabupaten) }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('kabupaten')
                            ...
                            <div class="form-group">
                                <label>Banjar</label>
                                <select id="banjar" name="banjar"
                                    class="form-control select2 @error('banjar') is-invalid @enderror"
                                    style="width: 100%;">
                                </select>
                                @error('banjar')
                                    <div class="invalid-feedback text-start">
                    ...
                    <div class="row d-flex justify-content-end mt-4">
                        <div class="col-8">
                            <p> Sudah memiliki akun? Klik
                                <a href="{{ route('form.user.login') }}" class="text-decoration-none link-primary">di
                                    sini</a>
                            </p>
                        </div>
                        <div class="col-4">
            ...
            <div class="text-center mt-4 mb-0">
                <a href="" class="nav-link link-dark">Posyandu &copy 2021</a>
            </div>
        </div>
    </div>
            ...
            $('#kabupaten').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#kecamatan').empty();
                        $('#kecamatan').append(
                            `<option value="0" disabled selected>Select Kecamatan</option>`);
            ...
            $('#kecamatan').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#desa').empty();
                        $('#desa').append(
                            `<option value="0" disabled selected>Select Desa/Kelurahan</option>`
                            );
                        response.forEach(element => {
                            $('#desa').append(
            ...
            $('#desa').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#banjar').empty();
                        $('#banjar').append(
                            `<option value="0" disabled selected>Select Banjar</option>`);
                        response.forEach(element => {
                            $('#banjar').append(
