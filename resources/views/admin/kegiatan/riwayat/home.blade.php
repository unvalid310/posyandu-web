                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#kegiatan-terlaksana"
                                    data-toggle="tab">Kegiatan Terlaksana</a></li>
                            <li class="nav-item"><a class="nav-link" href="#kegiatan-dibatalkan" data-toggle="tab">Kegiatan
                                    Dibatalkan</a></li>
                        </ul>
                    </div>
