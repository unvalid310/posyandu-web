            ...
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none"
                            href="{{ route('informasi_penting.home') }}">Berita</a></li>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('judul_informasi') }}" placeholder="Masukkan Judul Informasi"
                                            name="judul_informasi" id="" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="informasi" class="ckeditor @error('informasi') is-invalid @enderror" id="content"
                                            placeholder="Masukkan Konten" cols="30" rows="10" required>{!! old('informasi') !!}</textarea>
                                        @error('informasi')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('informasi_penting.home') }}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control @error('tag_berita[]') is-invalid @enderror"
                                            multiple="multiple" name="tag_berita[]" style="width: 100%;"
                                            data-placeholder="Pilih tag berita" required>
                                            @foreach ($tag as $data)
                                                <option value="1">{{ $data->nama_tag }}</option>
                                            @endforeach
                                        </select>
                                        @error('tag_berita[]')
                                            <div class="invalid-feedback text-start">
