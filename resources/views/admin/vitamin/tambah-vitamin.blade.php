                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        ...
                                        name="nama_vitamin" value="{{ old('nama_vitamin') }}" placeholder="Nama vitamin"
                                        required>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="status"
                                                ...
                                                value="{{ old('status') }}" id="status" required
                                                aria-placeholder="Pilih status vitamin">
                                                @if (old('status'))
                                                    @if (old('status') == 'Wajib')
                            ...
                            <div class="col-12 my-2">
                                <div class="form-floating">
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                        placeholder="Masukan keterangan tambahan" style="height: 120px" required autocomplete="off">{{ old('keterangan') }}</textarea>
