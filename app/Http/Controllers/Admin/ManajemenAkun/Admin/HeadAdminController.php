...
class HeadAdminController extends Controller
{
    ...
    public function semuaHeadAdmin()
    {
        if (auth()->guard('admin')->user()->role == 'super admin') {
            ...
            $head_admin = Pegawai::where('id_posyandu', auth()->guard('admin')->user()->pegawai->id_posyandu)->where('jabatan', 'head admin')->orderBy('id', 'desc')->get();
        }

        return view('admin.manajemen-akun.admin.head-admin.semua-head-admin', compact('head_admin'));
    }
    ...
    public function simpanHeadAdmin(Request $request)
    {
    ...
    public function detailHeadAdmin(Pegawai $pegawai)
    {
        return view('admin.manajemen-akun.admin.head-admin.detail-head-admin', compact('pegawai'));
    }

    public function updateHeadAdmin(Request $request, Pegawai $pegawai)
    {
