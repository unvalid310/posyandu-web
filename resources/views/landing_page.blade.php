...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container d-none d-lg-block">
            <div class="row">
                <div class="col-12 text-center mb-4 mt-5">
                    <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Posyandu<span
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-6 col-md-6 col-xl-2  d-block d-lg-none">
                        <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Sistem Posyandu<span
                                    class="text-primary">.</span> </a></h1>
                    </div>
                    ...
                    <div class="col-12 col-md-10 main-menu">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            ...
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                ...
                                <li><a href="#" class="nav-link"></a></li>
                                <li><a href="{{ route('form.user.login') }}"
                                        class="btn btn-primary mr-3 mb-2">Login</a></li>
                                <li><a href="{{ route('landing.regis') }}"
                                        class="btn btn-primary mr-3 mb-2">Registrasi</a></li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="col-md-12" style="position: relative;" data-aos="{{ asset('user-template') }}/fade-up">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-7 order-1 order-lg-2">
                                <img src="{{ asset('user-template') }}/images/landing_1.png" alt="Image"
                                    class="img-fluid">
                            </div>
                            <div class="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
                                <h1>Sistem Posyandu</h1>
                                <p class="mb-4">Sistem Posyandu merupakan sebuah layanan yang diberikan kepada
                                    masyarakat guna mempermudah pemantauan perkembangan ...Membantu para orang tua untuk
                                    memantau imunisasi anak mereka, melihat perkembangan anak mereka mulau dari berat
                                    badan, tinggi badan, hingga kesehatan anak mereka, serta yang terpenting semua dapat
    ...
    <div class="feature-big">
        <div class="container">
            <div class="row mb-5 site-section border-bottom">
                <div class="col-lg-7">
                    <img src="{{ asset('user-template') }}/images/do_ui_kit_download_cta_floating_devices-2x.png"
                        alt="Image" class="img-fluid">
                </div>
                <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
                    <h2 class="text-black">Bersama Posyandu</h2>
                    <p class="mb-4">Posyandu merupakan salah satu bentuk Upaya Kesehatan Bersumberdaya Masyarakat
                        (UKBM) yang dikelola dari, oleh, untuk, dan bersama masyarakat, guna memberdayakan masyarakat
                        dan memberikan kemudahan kepada masyarakat dalam perawatan anak khususnya bayi serta balita</p>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        ...
                        <div class="meta mb-4">Br.Kaja, Dalung <span class="mx-2">&bullet;</span> Jan 18, 2021<span
                                class="mx-2">&bullet;</span> <a href="#">News</a></div>
                        <p>Jenis pelayanan yang diselenggarakan posyandu untuk balita mencakup penimbangan berat badan,
                            pengukuran tinggi badan dan lingkar kepala anak, evaluasi tumbuh kembang, serta penyuluhan
                            dan konseling tumbuh kembang. Hasil pemeriksaan tersebut kemudian dicatat di dalam buku KIA
                            atau KMS.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        ...
                        <div class="meta mb-4">James Phelps <span class="mx-2">&bullet;</span> Jan 18, 2019<span
                                class="mx-2">&bullet;</span> <a href="#">News</a></div>
                        <p>Senam lansia merupakan olahraga yang cocok bagi lansia karena gerakan di dalamnya menghindari
                            gerakan loncat-loncat, melompat, kaki menyilang, maju mundur, menyentak-sentak namun masih
                            dapat memacu kerja jantung-paru dengan intensitas ringan-sedang, bersifat menyeluruh dengan
                            gerakan yang melibatkan sebagian besar otot tubuh</p>
                        <p><a href="#">Continue Reading...</a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <img src="{{ asset('user-template') }}/images/ibuHamil.jpg" alt="Image"
                            class="img-fluid">
                        <h2><a href="#">Program kesehatan ibu hamil</a></h2>
                        <div class="meta mb-4">James Phelps <span class="mx-2">&bullet;</span> Jan 18, 2019<span
                                class="mx-2">&bullet;</span> <a href="#">News</a></div>
                        <p> Pelayanan yang diberikan posyandu kepada ibu hamil mencakup pemeriksaan kehamilan dan
                            pemantauan gizi.Ibu hamil juga dapat melakukan konsultasi terkait persiapan persalinan dan
                            pemberian ASI.Setelah melahirkan, ibu juga bisa mendapatkan suplemen vitamin yang baik
                            dikonsumsi selama masa menyusui, serta pemasangan alat kontrasepsi (KB)</p>
                        <p><a href="#">Continue Reading...</a></p>
                    </div>
                </div>
    ...
    <div class="site-section" style="padding-top: 40px;" id="blog-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <img style="width:280px;height:280px" src="{{ asset('user-template') }}/images/pertama.png"
                            alt="Image" class="img-fluid">
                        <h2 style="text-align: center;"><a href="#">Pendaftaran</a></h2>
                        <p style="text-align: center;">Anda dapat melakukan pendaftaran online pada website resmi
                            Posyandu atau offline dengan mengunjungi posyandu terdekat di daerah anda</p>

                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <img style="width:280px;height:280px" src="{{ asset('user-template') }}/images/kedua.png"
                            alt="Image" class="img-fluid">
                        <h2 style="text-align: center;"><a href="#">Verifikasi Berkas</a></h2>

                        <p style="text-align: center;">Setelah mendaftarkan akun, maka akun anda akan di tinjau untuk
                            lebih lanjutnya sebagai verifikasi data untuk menggunakan layanan ini.</p>

                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    <div class="h-entry">
                        <img style="width:280px;height:280px" src="{{ asset('user-template') }}/images/ketiga.png"
                            alt="Image" class="img-fluid">
                        <h2 style="text-align: center;"><a href="#">Layanan Posyandu</a></h2>

                        <p style="text-align: center;">Jika data sudah selesai di verifkasi maka anda dapat meninjau
                            lebih lanjut sistem yang di tawarkan mulaui dari layanan bot telegram hingga report
                            kesehatan</p>
    ...
    <div class="site-section bg-light" id="about-section">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-6">
                    <img src="{{ asset('user-template') }}/images/about_1.png" alt="Image"
                        class="img-fluid mb-5 mb-lg-0 rounded shadow">
                </div>
                <div class="col-lg-5 ml-auto pl-lg-5">
                    <h2 class="text-black mb-4">Tentang Posyandu</h2>
                    <p class="mb-4">Posyandu merupakan salah satu bentuk Upaya Kesehatan Bersumberdaya Masyarakat
                        (UKBM) yang dikelola dari, oleh, untuk, dan bersama masyarakat, guna memberdayakan masyarakat
                        dan memberikan kemudahan kepada masyarakat dalam perawatan anak khususnya bayi serta balita.</p>
                ...
                <div class="col-12">
                    ...
                    <footer class="main-footer ">
                        <strong class="float-left">Copyright &copy; 2021
                            <a class="text-decoration-none link-primary" href="#">Sistem Informasi Posyandu
                                Terintegrasi</a>
                        </strong>
