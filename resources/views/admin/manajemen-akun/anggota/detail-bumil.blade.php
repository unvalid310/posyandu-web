        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Anggota') }}">Data Anggota
                            Posyandu</a></li>
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    src="{{ route('Get Profile Image Anggota', $anggota->id) }}?{{ date('YmdHis') }}"
                                    alt="Profile Anggota Bumil" width="150" height="150">
                            </div>
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                ...
                                <a
                                    class="float-right text-decoration-none link-dark">{{ $anggota->ibu->kehamilan_ke ?? 'Belum Ditambahkan' }}</a>
                            </li>
                            <li class="list-group-item">
                            ...
                            <li class="list-group-item">
                                ...
                                <a
                                    class="float-right text-decoration-none link-dark">{{ date('d M Y', strtotime($anggota->created_at)) }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills justify-content-center">
                            <li class="nav-item"><a class="nav-link active" id="tabProfile" href="#profile"
                                    data-toggle="tab">Profile</a></li>
                            <li class="nav-item"><a class="nav-link" id="tabInfo" href="#info"
                                    data-toggle="tab">Informasi</a></li>
                            <li class="nav-item"><a class="nav-link" id="tabUbahProfile" href="#ubahProfile"
                            ...
                            <div class="tab-pane active" id="profile">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $anggota->ibu->nama_ibu_hamil }}" disabled readonly>
                                    <label for="floatingInput">Nama Lengkap</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $anggota->ibu->NIK ?? 'Belum Ditambahkan' }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $anggota->ibu->tempat_lahir ?? 'Belum ditambahkan' }}" disabled
                                                readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ date('d M Y', strtotime($anggota->ibu->tanggal_lahir)) ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $anggota->ibu->nomor_telepon ?? 'Belum Ditambahkan' }}" disabled
                                                readonly>
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KK Anggota', $anggota->id_kk) }}?{{ date('YmdHis') }}"
                                        class="card-img-buttom" alt="Scan KK Anggota Ibu">
                                </div>
                            </div>
                            <div class="tab-pane" id="info">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            @if ($anggota->ibu->pendidikan_ibu == null)
                                                <input type="text" class="form-control" value="Belum ditambahkan"
                                                    disabled readonly>
                                            @else
                                                <input type="text" class="form-control"
                                                    value="{{ $anggota->ibu->pendidikan_ibu }}" disabled readonly>
                                            @endif
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->ibu->pendidikan_suami ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->ibu->pekerjaan_ibu ?? 'Belum Ditambahkan' }}" disabled
                                                readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->ibu->pekerjaan_suami ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control"
                                        value="{{ $anggota->ibu->alamat ?? 'Belum Ditambahkan' }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->agama ?? 'Belum Ditambahkan' }}" disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->tanggungan ?? 'Belum Ditambahkan' }}" disabled
                                                readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ $anggota->no_jkn ?? 'Belum Ditambahkan' }}" disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control"
                                                value="{{ date('d-M-Y', strtotime($anggota->masa_berlaku)) ?? 'Belum Ditambahkan' }}"
                                                disabled readonly>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control"
                                        value="{{ $anggota->faskes_rujukan ?? 'Belum Ditambahkan' }}" disabled readonly>
                                    <label for="floatingInput">Faskes Rujukan</label>
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Anggota Bumil', $anggota->ibu->id) }}" method="POST"
                                    class="form-horizontal needs-validation my-auto" novalidate>
                                    @csrf
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            class="form-control @error('nama') is-invalid @enderror" id="nama"
                                            value="{{ old('nama', $anggota->ibu->nama_ibu_hamil) }}"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $anggota->ibu->NIK) }}" placeholder="NIK ibu hamil"
                                            required>
                                        <label for="nik">Nomor Induk Kependudukan<span
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    id="tempat_lahir"
                                                    value="{{ old('tempat_lahir', $anggota->ibu->tempat_lahir) }}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        class="form-control @error('tgl_lahir') is-invalid @enderror"
                                                        value="{{ old('tgl_lahir', date('d-m-Y', strtotime($anggota->ibu->tanggal_lahir))) }}"
                                                        id="tgl_lahir" placeholder="Tanggal Lahir Ibu Hamil"
                                    ...
                                    <div class="form-floating mb-3">
                                        <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                            placeholder="Alamat tempat tinggal" style="height: 100px" required>{{ old('alamat', $anggota->ibu->alamat) }}</textarea>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <select name="tanggungan"
                                                        class="form-select @error('tanggungan') is-invalid @enderror"
                                                        id="tanggungan" required>
                                                        ...
                                                        @if ($anggota->tanggungan == 'Dengan Tanggungan')
                                                            <option selected value="Dengan Tanggungan">Dengan Tanggungan
                                                            </option>
                                                            <option value="Tanpa Tanggungan">Tanpa Tanggungan</option>
                                                        @endif
                                                        @if ($anggota->tanggungan == 'Tanpa Tanggungan')
                                                            <option selected value="Tanpa Tanggungan">Tanpa Tanggungan
                                                            </option>
                                                            <option value="Dengan Tanggungan">Dengan Tanggungan</option>
                                                        @endif
                                                    </select>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <select name="goldar"
                                                        class="form-select @error('goldar') is-invalid @enderror"
                                                        id="goldar">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="no_jkn"
                                                    class="form-control @error('no_jkn') is-invalid @enderror"
                                                    id="no_jkn" value="{{ old('no_jkn', $anggota->no_jkn ?? '') }}"
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    @if ($anggota->no_jkn == null)
                                                        <input type="text" name="masa_berlaku" autocomplete="off"
                                                            class="form-control @error('masa_berlaku') is-invalid @enderror"
                                                            id="masa_berlaku" placeholder="Masa berlaku JKN"
                                                            data-inputmask-alias="datetime"
                                                    ...
                                                    @else
                                                        <input type="text" name="masa_berlaku" autocomplete="off"
                                                            class="form-control @error('masa_berlaku') is-invalid @enderror"
                                                            value="{{ old('masa_berlaku', date('d-m-Y', strtotime($anggota->masa_berlaku))) }}"
                                                            id="masa_berlaku" placeholder="Masa berlaku JKN"
                                                            data-inputmask-alias="datetime"
                                                            data-inputmask-inputformat="dd-mm-yyyy" data-mask>
                                                        <label for="masa_berlaku">Masa Berlaku<span
                                                                class="text-danger">*</span></label>
                                                    @endif
                                                    @error('masa_berlaku')
                                                        <div class="invalid-feedback text-start">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="faskes_rujukan"
                                            class="form-control @error('faskes_rujukan') is-invalid @enderror"
                                            id="faskes_rujukan"
                                            value="{{ old('faskes_rujukan', $anggota->faskes_rujukan ?? '') }}"
                                            placeholder="Fasker rujukan">
                                        <label for="faskes_rujukan">Faskes Rujukan<span
                                                class="text-danger">*</span></label>
