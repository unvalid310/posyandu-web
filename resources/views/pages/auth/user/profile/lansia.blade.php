        ...
        <div class="col-auto ml-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('lansia.home') }}">Posyandu</a>
                    </li>
            ...
            <div class="col-md-5">
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    src="{{ Auth::user()->profile_image }}" alt="..." width="150" height="150">
                            </div>
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                ...
                                <a
                                    class="float-right text-decoration-none link-dark">{{ Auth::user()->lansia->posyandu->nama_posyandu }}</a>
                            </li>
                            <li class="list-group-item">
                                <b class="fw-bold">Terdaftar Sejak</b>
                                <a
                                    class="float-right text-decoration-none link-dark">{{ date('d-M-Y', strtotime(Auth::user()->created_at)) }}</a>
                            </li>
                        </ul>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('Keluarga Lansia') }}" class="btn btn-info btn-block">Lihat Riwayat Keluarga</a>
                    </div>
                </div>
            </div>
            <div class="col-md-7">
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#edit-profile" data-toggle="tab">Ubah Profile</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="email" class="form-control" id="inputNama" placeholder="Nama"
                                            disabled readonly value="{{ Auth::user()->lansia->nama_lansia }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputNIK" placeholder="NIK" disabled
                                            readonly value="{{ Auth::user()->lansia->NIK }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="email" class="form-control" id="inputNama" placeholder="Nama"
                                            disabled readonly value="{{ Auth::user()->lansia->status }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputTempatLahir"
                                            ...
                                            value="{{ Auth::user()->lansia->tempat_lahir }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 my-auto">
                                        <input type="text" class="form-control" id="inputTglLahir"
                                            ...
                                            value="{{ date('d-M-Y', strtotime(Auth::user()->lansia->tanggal_lahir)) }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane" id="account">
                                <form action="{{ route('edit.account.lansia') }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 my-auto">
                                            <input name="telegram" type="text"
                                                ...
                                                id="inputEmail" placeholder="Username Telegram"
                                                value="{{ old('telegram', Auth::user()->username_tele) }}">
                                            @error('telegram')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 my-auto">
                                            <input name="no_tlpn" type="text"
                                                ...
                                                id="inputEmail" placeholder="Nomor Telepon"
                                                value="{{ old('no_tlpn', Auth::user()->lansia->nomor_telepon) }}">
                                            @error('no_tlpn')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="tab-pane" id="edit-profile">
                                <form action="{{ route('edit.profile.user') }}" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 text-end">
                                            <button id="test" type="submit" class="btn btn-outline-success">Simpan
                                                Foto Profile</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form action="{{ route('edit.password.user') }}" method="POST" class="form-horizontal">
                                    ...
                                    @csrf
                                    <div class="form-group row">
                                        <label for="inputTelp" class="col-sm-3 col-form-label">Kata Sandi Lama<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9 my-auto">
                                            <input type="password" name="password_lama" autocomplete="off"
                                                class="form-control @error('password_lama') is-invalid @enderror"
                                                id="inputTelp" placeholder="Password Lama">
                                            @error('password_lama')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputTelp" class="col-sm-3 col-form-label">Kata Sandi Baru<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9 my-auto">
                                            <input type="password" name="password" autocomplete="off"
                                                class="form-control @error('password') is-invalid @enderror"
                                                id="inputTelp" placeholder="Password Baru">
                                            @error('password')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputTelp" class="col-sm-3 col-form-label">Konfirmasi Kata Sandi
                                            Baru<span class="text-danger">*</span></label>
                                        <div class="col-sm-9 my-auto">
                                            <input type="password" name="password_confirmation" autocomplete="off"
                                                class="form-control @error('password_confirmation') is-invalid @enderror"
                                                id="inputTelp" placeholder="Konfirmasi Password">
