        ...
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    {{-- <span class="wow fadeInDown" data-wow-delay=".2s"><a href="" class="text-decoration-none link-primary">Mulai Gunakan Posyandu</a></span> --}}
                    <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Posyandu Mempermudah Kesehatan Keluarga</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="graph mb-60">
                    <img src="index-template/img/we-do/graph-img.svg" alt="">
                </div>
            </div>
            <div class="col-lg-3">
