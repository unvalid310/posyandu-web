...
@push('css')
    ...
    <link rel="stylesheet"
        href="{{ asset('base-template/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
@endpush
                    ...
                    <div class="card-header">
                        <div class="row">
                            @permission('Tambah Kegiatan')
                                ...
                                <div class="col-6">
                                    <a class="btn btn-success float-right" href="{{ route('kegiatan.create') }}"><i
                                            ...
                                            <td class="align-middle">
                                                ...
                                                @permission('Broadcast Kegiatan')
                                                    <button class="btn btn-primary btn-sm my-1"
                                                        onclick="broadcastMessage('{{ $item->id }}')"><i
                                                            class="fab fa-telegram"></i></button>
                                                @endpermission
                                                @permission('Batalkan Kegiatan')
                                                    <button class="btn btn-danger btn-sm my-1"
                                                        onclick="batalkanKegiatan('{{ $item->id }}', '{{ $item->nama_kegiatan }}')"><i
