                ...
                <div class="card">
                    <div class="card-body">
                        <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-bumil-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-bumil" type="button" role="tab" aria-controls="nav-bumil"
                                aria-selected="true">Ibu Hamil</button>
                            ...
                            <button class="nav-link" id="nav-lansia-tab" data-bs-toggle="tab" data-bs-target="#nav-lansia"
                                type="button" role="tab" aria-controls="nav-lansia"
                                aria-selected="true">Lansia</button>
                        </div>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-bumil" role="tabpanel"
                                aria-labelledby="nav-bumil-tab">
                                @if (count($ibu) > 0)
                                            ...
                                            @foreach ($ibu as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    <td class="text-center align-middle d-md-none">
                                                        <a href="{{ route('Data Kesehatan Ibu', [$data->id]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($anak as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    <td class="text-center align-middle d-md-none">
                                                        <a href="{{ route('Data Kesehatan Anak', [$data->id]) }}"
                                                            class="btn btn-warning btn-sm">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
                                        ...
                                        <tbody>
                                            @foreach ($lansia as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    <td class="text-center align-middle d-md-none">
                                                        <a href="{{ route('Data Kesehatan Lansia', [$data->id]) }}"
                                                            class="btn btn-warning btn-sm">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
