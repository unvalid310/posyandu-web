        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Nakes') }}">Data Tenaga
                            Kesehatan</a></li>
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    src="{{ route('Get Profile Image Admin', $nakes->admin->id) }}" alt="Profile Admin"
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                ...
                                <a
                                    class="float-right text-decoration-none link-dark">{{ date('d M Y', strtotime($nakes->created_at)) }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active" id="profile">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $nakes->nama_nakes }}" disabled readonly>
                                    <label for="floatingInput">Nama Lengkap</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $nakes->nik }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $nakes->tempat_lahir }}" disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ old('email', date('d M Y', strtotime($nakes->tanggal_lahir))) }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $nakes->nomor_telepon ?? '-' }}" disabled readonly>
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KTP Nakes', $nakes->id) }}" class="card-img-buttom"
                                        alt="...">
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Profile Nakes', $nakes->id) }}" method="POST"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama', $nakes->nama_nakes) }}" placeholder="Nama Nakes"
                                            required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $nakes->nik) }}" placeholder="NIK Nakes" required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    id="floatingInput"
                                                    value="{{ old('tempat_lahir', $nakes->tempat_lahir) }}"
                                                    placeholder="Tempat Lahir Nakes" required>
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        ...
                                                        value="{{ old(date('d-m-Y', strtotime('tgl_lahir')), date('d-m-Y', strtotime($nakes->tanggal_lahir))) }}"
                                                        id="floatingInput" placeholder="Tanggal Lahir Nakes"
