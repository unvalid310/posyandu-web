...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3 col-lg-auto text-center text-md-start">Tambah Admin</h1>
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Admin') }}">Semua
                            Admin</a></li>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header my-auto">
                        <h3 class="card-title my-auto">Form Tambah Admin Baru</h3>
                    </div>
                    <div class="card-body p-0">
                        <div class="bs-stepper py-3">
                            ...
                            <form action="{{ route('Simpan Admin') }}" enctype="multipart/form-data" method="post"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        @else
                                                            <div class="invalid-feedback">
                                                                Jenis kelamin admin wajib dipilih
                                                            </div>
                                                        @enderror
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select name="lokasi_posyandu" id="lokasi_posyandu"
                                                                    ...
                                                                    style="width: 100%"
                                                                    aria-placeholder="Pilih lokasi posyandu ...">
                                                                ...
                                                                @else
                                                                    <div class="invalid-feedback">
                                                                        Tempat tugas admin wajib diisi
                                                                    </div>
                                                                @enderror
                                                            </div>
                                                        </div>
