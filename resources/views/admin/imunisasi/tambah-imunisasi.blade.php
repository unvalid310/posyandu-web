...
@section('title', 'Jenis Imunisasi Baru')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3 col-lg-auto text-center text-md-start">Tambah Jenis Imunisasi Baru</h1>
        <div class="col-auto ml-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Admin Home') }}">Posyandu</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Jenis Imunisasi Baru</li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        ...
                                        id="nama_imunisasi" name="nama_imunisasi" value="{{ old('nama_imunisasi') }}"
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        ...
                                        id="usia_pemberian" name="usia_pemberian" value="{{ old('usia_pemberian') }}"
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        ...
                                        name="perulangan" value="{{ old('perulangan') }}" placeholder="Frekuensi perulangan"
                                        required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="penerima"
                                                ...
                                                value="{{ old('penerima') }}" id="penerima"
                                                aria-placeholder="Pilih penerima imunisasi">
                                                @if (old('penerima'))
                            ...
                            <div class="col-12 my-2">
                                <div class="form-floating">
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                        placeholder="Masukan keterangan tambahan" autocomplete="off" required style="height: 120px">{{ old('keterangan') }}</textarea>
