        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Super Admin') }}">Data
                            Super Admin</a></li>
                        ...
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    src="{{ route('Get Profile Image Admin', $superAdmin->admin->id) }}?{{ date('YmdHis') }}"
                                    alt="Foto Profile Super Admin" width="150" height="150">
                            </div>
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                ...
                                @if ($superAdmin->area_tugas == 'Kabupaten')
                                    <a
                                        class="float-right text-decoration-none link-dark">{{ $superAdmin->kabupaten->nama_kabupaten }}</a>
                                @endif
                                @if ($superAdmin->area_tugas == 'Kecamatan')
                                    <a
                                        class="float-right text-decoration-none link-dark">{{ $superAdmin->kecamatan->nama_kecamatan }}</a>
                                @endif
                            </li>
                            <li class="list-group-item">
                                <b class="fw-bold">Terdaftar Sejak</b>
                                <a
                                    class="float-right text-decoration-none link-dark">{{ date('d M Y', strtotime($superAdmin->created_at)) }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#profile" id="tabProfile"
                                    data-toggle="tab">Profile</a></li>
                            <li class="nav-item"><a class="nav-link" href="#ubahProfile" id="tabUbahProfile"
                                    data-toggle="tab">Ubah Profile</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="tab-pane active" id="profile">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $superAdmin->nama_super_admin }}" disabled readonly>
                                    <label for="floatingInput">Nama Lengkap</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $superAdmin->nik }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $superAdmin->tempat_lahir }}" disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ old('tanggal_lahir', date('d M Y', strtotime($superAdmin->tanggal_lahir))) }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $superAdmin->nomor_telepon ?? 'Belum ditambahkan' }}" disabled
                                                readonly>
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KTP Super Admin', $superAdmin->id) }}?{{ date('YmdHis') }}"
                                        class="card-img-buttom" alt="File KTP Super Admin">
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Profile Super Admin', $superAdmin->id) }}" method="POST"
                                    class="needs-validation form-horizontal my-auto" novalidate>
                                    @csrf
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            class="form-control @error('nama') is-invalid @enderror" id="floatingInput"
                                            value="{{ old('nama', $superAdmin->nama_super_admin) }}"
                                            placeholder="Nama Super Admin" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $superAdmin->nik) }}" placeholder="NIK Super Admin"
                                            required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    id="floatingInput"
                                                    value="{{ old('tempat_lahir', $superAdmin->tempat_lahir) }}"
                                                    placeholder="Tempat Lahir Super Admin" required>
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        ...
                                                        value="{{ old(date('d-m-Y', strtotime('tgl_lahir')), date('d-m-Y', strtotime($superAdmin->tanggal_lahir))) }}"
                                                        id="floatingInput" placeholder="Tanggal Lahir Super Admin"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 d-grid">
                                            <button type="submit" class="btn btn-outline-success my-1">Simpan Perubahan
                                                Data</button>
                                        </div>
                                    </div>
                                </form>
