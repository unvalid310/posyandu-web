        ...
        <div class="col-auto ml-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Admin') }}">Data
                            Admin</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="profile">
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KTP Admin', $pegawai->id) }}" class="card-img-buttom"
                                        alt="KTP Head Admin">
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Admin', $pegawai->id) }}" method="POST"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama', $pegawai->nama_pegawai) }}" placeholder="Nama Admin"
                                            required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $pegawai->nik) }}" placeholder="NIK Admin" required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    placeholder="Tempat Lahir Admin" required>
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        ...
                                                        id="floatingInput" placeholder="Tanggal Lahir Admin"
