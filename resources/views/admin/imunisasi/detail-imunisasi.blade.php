            ...
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none"
                            href="{{ route('Semua Jenis Imunisasi') }}">Semua Jenis Imunisasi</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline card-primary p-3">
                    <form action="{{ route('Update Imunisasi', $imunisasi->id) }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        class="form-control @error('nama_imunisasi') is-invalid @enderror"
                                        id="nama_imunisasi" name="nama_imunisasi"
                                        value="{{ old('nama_imunisasi', $imunisasi->nama_imunisasi) }}"
                                        placeholder="Nama Imunisasi" required>
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        ...
                                        value="{{ old('usia_pemberian', $imunisasi->usia_pemberian) }}"
                            ...
                            <div class="col-sm-12 col-md-6 my-2">
                                ...
                                <div class="input-group">
                                    <input type="text" autocomplete="off"
                                        ...
                                        name="perulangan" value="{{ old('perulangan', $imunisasi->perulangan) }}"
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="status"
                                                ...
                                                aria-placeholder="Pilih status imunisasi" required>
                                                @if ($imunisasi->status == 'Wajib')
                                                    <option value="{{ old('status', $imunisasi->status) }}" selected>
                                                        {{ old('status', $imunisasi->status) }}</option>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select name="penerima"
                                                ...
                                                aria-placeholder="Pilih penerima imunisasi" id="penerima">
                                                @if ($imunisasi->penerima == 'Ibu Hamil')
                                                    @if (old('penerima'))
                                                        ...
                                                        @endif
                                                    @else
                                                        <option value="{{ old('penerima', $imunisasi->penerima) }}"
                                                            selected>{{ old('penerima', $imunisasi->penerima) }}</option>
                                                        <option value="Anak">Anak</option>
                                                        <option value="Lansia">Lansia</option>
                                                    @endif
                                                @endif
                            ...
                            <div class="col-12 my-2">
                                <div class="form-floating">
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                        placeholder="Masukan keterangan tambahan" autocomplete="off" style="height: 120px" required>{{ old('keterangan', $imunisasi->deskripsi) }}</textarea>
