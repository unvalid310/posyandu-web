                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 my-1">
                                <ul class="nav nav-pills d-flex justify-content-center justify-content-md-start">
                                    <li class="nav-item"><a class="nav-link active" href="#tbIbu" data-toggle="tab">Ibu
                                            Hamil</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#tbAnak" data-toggle="tab">Anak</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#tbLansia" data-toggle="tab">Lansia</a>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    @permission('Ubah Anggota')
                                                        <td class="text-center align-middle">
                                                            <a href="{{ route('Detail Anggota Bumil', $data->id) }}"
                                                            ...
                                                            @if ($data->user->status == '1')
                                                                @permission('Nonaktifkan Anggota')
                                                                    <button class="btn btn-danger btn-sm my-1"
                                                                        onclick="disableAccount('{{ $data->user->id }}')">
                                        ...
                                        @if ($anak != null)
                                            @foreach ($anak as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    @permission('Ubah Anggota')
                                                        <td class="text-center align-middle">
                                                            <a href="{{ route('Detail Anggota Anak', $data->id) }}"
                                                                class="btn btn-warning btn-sm">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            @if ($data->user->status == '1')
                                        ...
                                        @if ($lansia != null)
                                            @foreach ($lansia as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    @permission('Ubah Anggota')
                                                        <td class="text-center align-middle">
                                                            <a href="{{ route('Detail Anggota Lansia', $data->id) }}"
                                                                class="btn btn-warning btn-sm">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            @if ($data->user->status == '1')
