        ...
        <div class="col-auto ml-auto text-right my-auto mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Data Head Admin') }}">Data
                            Admin</a></li>
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <div class="image mx-auto d-block rounded">
                                <img class="profile-user-img img-fluid img-circle mx-auto d-block"
                                    src="{{ route('Get Profile Image Admin', $pegawai->admin->id) }}"
                                    alt="Profile Head Admin" width="150" height="150">
                            </div>
                        </div>
                        <h3 class="profile-username text-center">{{ $pegawai->nama_pegawai }}</h3>
                        <p class="text-muted text-center">{{ $pegawai->admin->email }}</p>
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                ...
                                <a
                                    class="float-right text-decoration-none link-dark">{{ $pegawai->posyandu->nama_posyandu }}</a>
                            </li>
                            <li class="list-group-item">
                                <b class="fw-bold">Terdaftar Sejak</b>
                                <a
                                    class="float-right text-decoration-none link-dark">{{ date('d M Y', strtotime($pegawai->created_at)) }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active" id="profile">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $pegawai->nama_pegawai }}" disabled readonly>
                                    <label for="floatingInput">Nama Lengkap</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        value="{{ $pegawai->nik }}" disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $pegawai->tempat_lahir }}" disabled readonly>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ old('email', date('d M Y', strtotime($pegawai->tanggal_lahir))) }}"
                                                disabled readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                value="{{ $pegawai->nomor_telepon ?? '-' }}" disabled readonly>
                                ...
                                <div class="card shadow-none">
                                    ...
                                    <img src="{{ route('Get KTP Head Admin', $pegawai->id) }}" class="card-img-buttom"
                                        alt="KTP Head Admin">
                                </div>
                            </div>
                            <div class="tab-pane" id="ubahProfile">
                                <form action="{{ route('Update Head Admin', $pegawai->id) }}" method="POST"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama', $pegawai->nama_pegawai) }}"
                                            placeholder="Nama Head Admin" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $pegawai->nik) }}" placeholder="NIK Head Admin"
                                            required>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="tempat_lahir"
                                                    ...
                                                    placeholder="Tempat Lahir Head Admin" required>
                                            ...
                                            <div class="form-group">
                                                <div class="form-floating">
                                                    <input type="text" name="tgl_lahir" autocomplete="off"
                                                        ...
                                                        value="{{ old(date('d-m-Y', strtotime('tgl_lahir')), date('d-m-Y', strtotime($pegawai->tanggal_lahir))) }}"
                                                        id="floatingInput" placeholder="Tanggal Lahir Head Admin"
