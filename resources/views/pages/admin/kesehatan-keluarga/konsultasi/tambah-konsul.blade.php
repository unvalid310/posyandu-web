                                        ...
                                        <tbody>
                                            @foreach ($ibu as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    <td class="align-middle d-none d-md-table-cell">{{ $data->nama_suami }}
                                                    </td>
                                                    <td class="text-center align-middle d-md-none">
                                                        <a href="{{ route('Konsultasi Ibu', [$data->id]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($anak as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    <td class="align-middle d-none d-md-table-cell">{{ $data->nama_ibu }}
                                                    </td>
                                                    <td class="text-center align-middle d-md-none">
                                                        <a href="{{ route('Konsultasi Anak', [$data->id]) }}"
                                                            class="btn btn-warning btn-sm">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
                                        ...
                                        <tbody>
                                            @foreach ($lansia as $data)
                                                <tr class="text-center align-middle my-auto">
                                                    ...
                                                    <td class="align-middle d-none d-md-table-cell">{{ $data->status }}
                                                    </td>
                                                    <td class="text-center align-middle d-md-none">
                                                        <a href="{{ route('Konsultasi Lansia', [$data->id]) }}"
                                                            class="btn btn-warning btn-sm">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
